...
export const SEQUENCE_EMAILS: SequenceEmail[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "— Jay",
      "<strong>P.S.</strong> The brain is software now. $97/month. Try it.",
    ],
  },
  {
    step: 6,
    ...
    paragraphs: [
      ...
      "— You sign up for $97/month<br/>— You run your first \"I've got a guy\" tonight<br/>— The engine returns the full case design<br/>— You see the opportunities sitting in your book that you didn't know were there<br/>— 30 days later, if you didn't find an opportunity, we refund you — no questions asked",
